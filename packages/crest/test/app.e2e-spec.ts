            ...
            describe("one cat", () => {
                it("should get a single cat", () => {
                    return request(app.getHttpServer())
                        .post(gql)
                        .send({
                            query: '{getCat(catId:{id:"2"}){id name age breed}}',
                        })
                        .expect(200)
                        .expect((res) => {
                ...
                it("should get an error for bad id", () => {
                    return request(app.getHttpServer())
                        .post(gql)
                        .send({
                            query: '{getCat(catId: {id:"500"}){id name age breed}}',
                        })
                        .expect(200)
                        .expect((res) => {
            ...
            it("should create a new cat and have it added to the array", () => {
                return (
                    request(app.getHttpServer())
                        .post(gql)
                        .send({
                            query: 'mutation {insertCat(newCat: { name: "Vanitas", breed: "Calico", age: 100 }) {breed name id age}}',
                        })
                        .expect(200)
                        .expect((res) => {
                        ...
                        .then(() =>
                            request(app.getHttpServer())
                                .post(gql)
                                .send({
                                    query: "{getCats {id name breed age}}",
                                })
                                .expect(200)
                                .expect((res) => {
